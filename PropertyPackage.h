...
public:
 ...
 double solvePengRobinsonEq(double T, double press, vector<double> xmol);
 ...
 double twoPhaseSolution(double T, vector<double> xmol,double P0);
 double calcD(double press, double temp, vector<double> xmol);
};
